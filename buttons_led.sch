...
F 4 "https://www.digikey.com/product-detail/en/omron-electronics-inc-emc-div/B3U-3000P/SW1022CT-ND/1534359" H 3250 3500 60  0001 C CNN "Distrib Link"
	1    3250 3500
	1    0    0    -1  
$EndComp
$Comp
...
F 4 "https://www.digikey.com/product-detail/en/omron-electronics-inc-emc-div/B3U-3000P/SW1022CT-ND/1534359" H 3250 2250 60  0001 C CNN "Distrib Link"
	1    3250 2250
	1    0    0    -1  
$EndComp
$Comp
...
F 4 "https://www.digikey.com/product-detail/en/omron-electronics-inc-emc-div/B3U-3000P/SW1022CT-ND/1534359" H 3250 6000 60  0001 C CNN "Distrib Link"
	1    3250 6000
	1    0    0    -1  
$EndComp
Wire Wire Line
...
U 1 1 5ACC4CAE
P 2900 3900
F 0 "#PWR1402" H 2900 3650 50  0001 C CNN
...
U 1 1 5ACC4CDD
P 2900 2650
F 0 "#PWR1401" H 2900 2400 50  0001 C CNN
...
U 1 1 5ACC4EB3
P 2900 6400
F 0 "#PWR1404" H 2900 6150 50  0001 C CNN
...
U 1 1 5ACC7D2C
P 8600 4000
F 0 "#PWR1419" H 8600 3750 50  0001 C CNN
...
U 1 1 5AEA32FD
P 8600 2800
F 0 "#PWR1418" H 8600 2650 50  0001 C CNN
...
F 4 "https://www.digikey.com/product-detail/en/omron-electronics-inc-emc-div/B3U-3000P/SW1022CT-ND/1534359" H 3250 4750 60  0001 C CNN "Distrib Link"
	1    3250 4750
	1    0    0    -1  
$EndComp
Wire Wire Line
...
U 1 1 5AFE7AC6
P 2900 5150
F 0 "#PWR1403" H 2900 4900 50  0001 C CNN
...
U 1 1 5AF882B5
P 3700 3900
F 0 "#PWR1412" H 3700 3650 50  0001 C CNN
...
U 1 1 5AF899AE
P 3700 2650
F 0 "#PWR1410" H 3700 2400 50  0001 C CNN
...
U 1 1 5AF8B58A
P 3700 6400
F 0 "#PWR1416" H 3700 6150 50  0001 C CNN
...
U 1 1 5AF8B7F2
P 3700 5150
F 0 "#PWR1414" H 3700 4900 50  0001 C CNN
...
U 1 1 5AFF8032
P 7900 4150
F 0 "#PWR1417" H 7900 3900 50  0001 C CNN
...
U 1 1 5B11FB3A
P 3500 6400
F 0 "#PWR1408" H 3500 6150 50  0001 C CNN
...
U 1 1 5B126346
P 3500 5150
F 0 "#PWR1407" H 3500 4900 50  0001 C CNN
...
U 1 1 5B1268EE
P 3500 2650
F 0 "#PWR1405" H 3500 2400 50  0001 C CNN
...
U 1 1 5B126BC2
P 3500 3900
F 0 "#PWR1406" H 3500 3650 50  0001 C CNN
...
U 1 1 5B1DEF78
P 3700 3100
F 0 "#PWR1411" H 3700 2950 50  0001 C CNN
...
U 1 1 5B1DEFD5
P 3700 1850
F 0 "#PWR1409" H 3700 1700 50  0001 C CNN
...
U 1 1 5B1DF336
P 3700 5600
F 0 "#PWR1415" H 3700 5450 50  0001 C CNN
...
U 1 1 5B1DF393
P 3700 4350
F 0 "#PWR1413" H 3700 4200 50  0001 C CNN
