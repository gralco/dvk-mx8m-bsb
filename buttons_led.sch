...
U 1 1 5ACC398C
P 3200 1700
F 0 "SW1301" H 3250 1800 50  0000 L CNN
...
U 1 1 5ACC39A6
P 3200 2450
F 0 "SW1302" H 3250 2550 50  0000 L CNN
F 1 "SW_Push" H 3200 2390 50  0000 C CNN
...
U 1 1 5ACC3A06
P 3200 3200
F 0 "SW1303" H 3250 3300 50  0000 L CNN
...
U 1 1 5ACC3A3E
P 3200 3950
F 0 "SW1304" H 3250 4050 50  0000 L CNN
F 1 "SW_Push" H 3200 3890 50  0000 C CNN
...
U 1 1 5ACC3AC2
P 3200 4700
F 0 "SW1305" H 3250 4800 50  0000 L CNN
F 1 "SW_Push" H 3200 4640 50  0000 C CNN
...
U 1 1 5ACC4A3B
P 2950 2100
F 0 "#PWR0176" H 2950 1850 50  0001 C CNN
...
U 1 1 5ACC4CAE
P 2950 2850
F 0 "#PWR0177" H 2950 2600 50  0001 C CNN
...
U 1 1 5ACC4CDD
P 2950 3600
F 0 "#PWR0178" H 2950 3350 50  0001 C CNN
...
U 1 1 5ACC4E99
P 2950 4350
F 0 "#PWR0179" H 2950 4100 50  0001 C CNN
...
U 1 1 5ACC4EB3
P 2950 5100
F 0 "#PWR0180" H 2950 4850 50  0001 C CNN
...
U 1 1 5ACC7D2C
P 8750 3950
F 0 "#PWR0181" H 8750 3700 50  0001 C CNN
...
SW_BACK
Text HLabel 4150 2450 2    60   Output ~ 0
SW_VOLDN
Text HLabel 4150 3200 2    60   Output ~ 0
SW_VOLUP
...
U 1 1 5AEA32FD
P 8750 2750
F 0 "#PWR0182" H 8750 2600 50  0001 C CNN
...
U 1 1 5AFE7AB5
P 3200 5450
F 0 "SW1306" H 3250 5550 50  0000 L CNN
F 1 "SW_Push" H 3200 5390 50  0000 C CNN
...
U 1 1 5AFE7AC6
P 2950 5850
F 0 "#PWR0183" H 2950 5600 50  0001 C CNN
...
Wire Wire Line
	3400 5450 4150 5450
Text HLabel 4150 5450 2    60   Output ~ 0
SYS_~RST
...
U 1 1 5B070EE4
P 3650 3000
F 0 "R1304" H 3825 3050 50  0000 C CNN
F 1 "10k" H 3775 2950 50  0000 C CNN
...
F 1 "3V3_P" H 3650 2940 50  0000 C CNN
...
U 1 1 5B071BF2
P 2950 1900
F 0 "R1302" H 3125 1950 50  0000 C CNN
F 1 "33" H 3050 1850 50  0000 C CNN
...
U 1 1 5B077FFE
P 3650 2050
F 0 "#PWR0185" H 3650 1900 50  0001 C CNN
F 1 "3V3_P" H 3650 2190 50  0000 C CNN
...
U 1 1 5B0787FA
P 2950 2650
F 0 "R1303" H 3125 2700 50  0000 C CNN
F 1 "33" H 3050 2600 50  0000 C CNN
...
U 1 1 5B078851
P 2950 3400
F 0 "R1305" H 3125 3450 50  0000 C CNN
F 1 "33" H 3050 3350 50  0000 C CNN
...
U 1 1 5B0788EA
P 2950 4150
F 0 "R1306" H 3125 4200 50  0000 C CNN
F 1 "33" H 3050 4100 50  0000 C CNN
...
U 1 1 5B07894D
P 2950 4900
F 0 "R1307" H 3125 4950 50  0000 C CNN
F 1 "33" H 3050 4850 50  0000 C CNN
...
U 1 1 5B0789B5
P 2950 5650
F 0 "R1308" H 3125 5700 50  0000 C CNN
F 1 "33" H 3050 5600 50  0000 C CNN
...
U 1 1 5B078F84
P 3650 2250
F 0 "R1309" H 3825 2300 50  0000 C CNN
F 1 "10k" H 3775 2200 50  0000 C CNN
...
U 1 1 5B16D24E
P 3650 5250
F 0 "R1310" H 3825 5300 50  0000 C CNN
F 1 "NC" H 3775 5200 50  0000 C CNN
...
U 1 1 5B16D254
P 3650 5050
F 0 "#PWR0186" H 3650 4900 50  0001 C CNN
F 1 "3V3_P" H 3650 5190 50  0000 C CNN
