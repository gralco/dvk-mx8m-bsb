...
U 1 1 5ACC4CAE
P 2850 2900
F 0 "#PWR0176" H 2850 2650 50  0001 C CNN
...
U 1 1 5ACC4CDD
P 2850 4100
F 0 "#PWR0177" H 2850 3850 50  0001 C CNN
...
U 1 1 5ACC4EB3
P 2850 5800
F 0 "#PWR0178" H 2850 5550 50  0001 C CNN
...
U 1 1 5ACC7D2C
P 8750 4000
F 0 "#PWR0179" H 8750 3750 50  0001 C CNN
...
U 1 1 5AEA32FD
P 8750 2800
F 0 "#PWR0180" H 8750 2650 50  0001 C CNN
...
U 1 1 5AFE7AC6
P 2850 7000
F 0 "#PWR0181" H 2850 6750 50  0001 C CNN
...
U 1 1 5B071BF2
P 2450 1100
F 0 "R1301" H 2625 1150 50  0000 C CNN
...
U 1 1 5B0787FA
P 2850 2700
F 0 "R1303" H 3025 2750 50  0000 C CNN
...
U 1 1 5B078851
P 2850 3900
F 0 "R1304" H 3025 3950 50  0000 C CNN
...
U 1 1 5B0788EA
P 2450 4350
F 0 "R1302" H 2625 4400 50  0000 C CNN
...
U 1 1 5B07894D
P 2850 5600
F 0 "R1305" H 3025 5650 50  0000 C CNN
...
U 1 1 5B0789B5
P 2850 6800
F 0 "R1306" H 3025 6850 50  0000 C CNN
...
U 1 1 5B16D254
P 3650 6200
F 0 "#PWR0182" H 3650 6050 50  0001 C CNN
...
U 1 1 5AF8646F
P 3650 1700
F 0 "#PWR0183" H 3650 1450 50  0001 C CNN
...
U 1 1 5AF882B5
P 3650 2900
F 0 "#PWR0184" H 3650 2650 50  0001 C CNN
...
U 1 1 5AF899AE
P 3650 4100
F 0 "#PWR0185" H 3650 3850 50  0001 C CNN
...
U 1 1 5AF8B0AA
P 3650 4950
F 0 "#PWR0186" H 3650 4700 50  0001 C CNN
...
U 1 1 5AF8B58A
P 3650 5800
F 0 "#PWR0187" H 3650 5550 50  0001 C CNN
...
U 1 1 5AF8B7F2
P 3650 7000
F 0 "#PWR0188" H 3650 6750 50  0001 C CNN
...
U 1 1 5AFF8032
P 8050 4150
F 0 "#PWR0189" H 8050 3900 50  0001 C CNN
...
U 1 1 5B0B843E
P 3650 2100
F 0 "#PWR0190" H 3650 1950 50  0001 C CNN
...
U 1 1 5B0BA66C
P 3650 3300
F 0 "#PWR0191" H 3650 3150 50  0001 C CNN
...
U 1 1 5B1502EE
P 2450 4150
F 0 "#PWR0192" H 2450 4000 50  0001 C CNN
...
U 1 1 5B1B7426
P 2450 900
F 0 "#PWR0193" H 2450 750 50  0001 C CNN
...
U 1 1 5B11A1E5
P 3450 5600
F 0 "D1306" V 3425 5400 50  0000 C CNN
...
U 1 1 5B11FB3A
P 3450 5800
F 0 "#PWR0194" H 3450 5550 50  0001 C CNN
...
U 1 1 5B124807
P 3450 2700
F 0 "D1303" V 3425 2500 50  0000 C CNN
...
U 1 1 5B124B49
P 3450 3900
F 0 "D1304" V 3425 3700 50  0000 C CNN
...
U 1 1 5B125391
P 3450 4750
F 0 "D1305" V 3425 4550 50  0000 C CNN
...
U 1 1 5B125D7F
P 3450 6800
F 0 "D1307" V 3425 6600 50  0000 C CNN
...
U 1 1 5B126346
P 3450 7000
F 0 "#PWR0195" H 3450 6750 50  0001 C CNN
...
U 1 1 5B126731
P 3450 4950
F 0 "#PWR0196" H 3450 4700 50  0001 C CNN
...
U 1 1 5B1268EE
P 3450 4100
F 0 "#PWR0197" H 3450 3850 50  0001 C CNN
...
U 1 1 5B126BC2
P 3450 2900
F 0 "#PWR0198" H 3450 2650 50  0001 C CNN
...
U 1 1 5B12748B
P 3450 1500
F 0 "D1302" V 3425 1300 50  0000 C CNN
...
U 1 1 5B12752F
P 3450 1700
F 0 "#PWR0199" H 3450 1450 50  0001 C CNN
