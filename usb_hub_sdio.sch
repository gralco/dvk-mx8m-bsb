...
U 1 1 5AFD422F
P 6500 6050
F 0 "#PWR0163" H 6500 5800 50  0001 C CNN
...
F 1 "12MHz" H 6500 5800 50  0000 C CNN
F 2 "" H 6300 5550 50  0001 C CNN
F 3 "http://www.ecsxtal.com/store/pdf/ECX-2236.pdf" H 6300 5550 50  0001 C CNN
F 4 "ECS" V 6300 5550 60  0001 C CNN "MFG Name"
F 5 "ECS-120-12-36-AGN-TR" V 6300 5550 60  0001 C CNN "MFG Part Num"
F 6 "ECS-120-12-36-AGN-TR" V 6300 5550 60  0001 C CNN "Distrib PN"
F 7 "https://www.arrow.com/en/products/ecs-120-12-36-agn-tr/ecs-international" V 6300 5550 60  0001 C CNN "Distrib Link"
F 8 "-" V 6300 5550 60  0001 C CNN "Tolerance"
F 9 "https://www.digikey.com/products/en/crystals-oscillators-resonators/crystals/171?k=&pkeyword=&pv69=3&FV=1f140000%2Cmu12MHz%7C2150%2Cffe000ab%2C8c0001%2C8c0010%2C8c0005%2C8c0008&quantity=0&ColumnSort=1000011&page=1&pageSize=500" V 6300 5550 60  0001 C CNN "Others"
	1    6300 5550
	1    0    0    -1  
$EndComp
$Comp
...
U 1 1 5AF52101
P 4200 2900
F 0 "#PWR0164" H 4200 2650 50  0001 C CNN
...
U 1 1 5B07B0B9
P 6150 5150
F 0 "#PWR0165" H 6150 4900 50  0001 C CNN
...
U 1 1 5B07B125
P 5550 5150
F 0 "#PWR0166" H 5550 4900 50  0001 C CNN
...
U 1 1 5B07B2AA
P 7100 4450
F 0 "#PWR0167" H 7100 4200 50  0001 C CNN
...
U 1 1 5B07B66F
P 4500 4450
F 0 "#PWR0168" H 4500 4200 50  0001 C CNN
...
U 1 1 5B09CA5D
P 10300 950
F 0 "#PWR0169" H 10300 800 50  0001 C CNN
...
U 1 1 5B0B1862
P 10300 2600
F 0 "#PWR0170" H 10300 2350 50  0001 C CNN
...
U 1 1 5B0B5C77
P 3750 4000
F 0 "#PWR0171" H 3750 3750 50  0001 C CNN
...
U 1 1 5B0FBCD9
P 6100 1800
F 0 "#PWR0172" H 6100 1550 50  0001 C CNN
...
U 1 1 5B0FF7C5
P 6450 2350
F 0 "#PWR0173" H 6450 2100 50  0001 C CNN
...
U 1 1 5B101B5E
P 5950 6050
F 0 "#PWR0174" H 5950 5800 50  0001 C CNN
...
U 1 1 5B104C14
P 8000 3900
F 0 "#PWR0175" H 8000 3650 50  0001 C CNN
...
U 1 1 5B1079D0
P 8250 3900
F 0 "#PWR0176" H 8250 3650 50  0001 C CNN
...
U 1 1 5B10E3EB
P 3250 3850
F 0 "#PWR0177" H 3250 3600 50  0001 C CNN
...
U 1 1 5B10EE23
P 3100 3350
F 0 "#PWR0178" H 3100 3200 50  0001 C CNN
...
U 1 1 5B112BA0
P 4850 5750
F 0 "#PWR0179" H 4850 5500 50  0001 C CNN
...
U 1 1 5B11D61C
P 5000 5950
F 0 "#PWR0180" H 5000 5700 50  0001 C CNN
...
U 1 1 5B169FFA
P 4900 1550
F 0 "#PWR0181" H 4900 1400 50  0001 C CNN
...
U 1 1 5B16A294
P 5300 2000
F 0 "#PWR0182" H 5300 1750 50  0001 C CNN
...
U 1 1 5B16A2F7
P 4900 2000
F 0 "#PWR0183" H 4900 1750 50  0001 C CNN
...
U 1 1 5B16E4EF
P 5850 2550
F 0 "#PWR0184" H 5850 2400 50  0001 C CNN
